<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudPiso3.aspx.cs" Inherits="ProyectoFinal.pages.SolicitudPiso3" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class ="col-md-8">
                                <div class="PanelMapa">
                                    <img class="img-responsive" id ="mapaDePiso1" src="../img/Laboratorio3.png" alt="Alternate Text" />
                                    <asp:Button ID="btnAula1Piso3"  runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula2Piso3"  runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula3Piso3"  runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula4Piso3"  runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula5Piso3" class="BotonesAulas" runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula6Piso3" class="BotonesAulas" runat="server" Text="Button" />
                                    <div class ="clear"></div>
                                </div>
                            </div>
                            <div class=".col-md-4">
                                ...
                                <br class="auto-style1" />
                                      ...
                                      <asp:DropDownList runat="server" OnSelectedIndexChanged="Unnamed2_SelectedIndexChanged">
