<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudPiso2.aspx.cs" Inherits="ProyectoFinal.pages.SolicitudPiso2" %>
                        ...
                        <div class="panel-body">
                            <div class ="col-md-8">
                                <div class="PanelMapa">
                                    ...
                                    <asp:Button ID="btnAula4Piso2"  runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula5Piso2" class="BotonesAulas" runat="server"  Text="Button" />
                                    <asp:Button ID="btnAula6Piso2" class="BotonesAulas" runat="server" Text="Button" />
                                    <div class ="clear"></div>
                                </div>
                            </div>
                            <div class=".col-md-4">
